...
static PyMethodDef mod_rgyq20yb_methods[] = {
    {
...
static struct PyModuleDef mod_rgyq20yb_module = {
    ...
    -1,
    mod_rgyq20yb_methods
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_rgyq20yb(void)
{
    PyObject *m;

    import_array();

    m = PyModule_Create(&mod_rgyq20yb_module);
