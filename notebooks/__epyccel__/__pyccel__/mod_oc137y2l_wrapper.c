...
static PyMethodDef mod_oc137y2l_methods[] = {
    {
...
static struct PyModuleDef mod_oc137y2l_module = {
    ...
    -1,
    mod_oc137y2l_methods
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_oc137y2l(void)
{
    PyObject *m;

    import_array();

    m = PyModule_Create(&mod_oc137y2l_module);
